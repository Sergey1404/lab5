...
namespace lab5 {
    ...
    public class Corrector {
        ...
        private List<string> AddMisspelled(List<string> Misspelled) {
            string Word;
            Console.WriteLine("Добавляйте вариации. Введите 0, чтобы остановиться.");
            while (true) {
        ...
        private void AddWord() {
            ...
            Console.WriteLine("Новое слово добавлено.");
        }
        ...
        private void EditWords(string FileName) {
            ...
            Console.WriteLine("Редактировние завершено.");
            Console.ReadKey();
        }
        ...
        public void Program() {
            ...
            while (true) {
                Console.Clear();
                Console.WriteLine("Добавить новое слово в словарь     0");
                Console.WriteLine("Изменить текст                     1");
                Console.WriteLine("Изменить число                     2");
